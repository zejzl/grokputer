...
if not XAI_API_KEY:
    raise ValueError(
        "XAI_API_KEY not found in environment variables. " "Please copy .env.example to .env and add your API key."
    )
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "agent_name": {"type": "string", "description": "Agent name (required for 'agent_stats')"},
                    "limit": {
                        "type": "integer",
