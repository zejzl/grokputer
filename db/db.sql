...
-- Natural Language Interface Conversation Schema
-- For persistent conversation history and context
...
CREATE TABLE IF NOT EXISTS conversations (
    ...
    metadata TEXT  -- JSON: preferences, context_variables, etc.
);
...
CREATE TABLE IF NOT EXISTS conversation_messages (
    ...
    timestamp DATETIME DEFAULT CURRENT_TIMESTAMP,
    metadata TEXT,  -- JSON: intent, task_data, etc.
...
CREATE TABLE IF NOT EXISTS user_preferences (
    ...
    confidence REAL DEFAULT 1.0,  -- How confident we are in this preference
    last_updated DATETIME DEFAULT CURRENT_TIMESTAMP,
    source TEXT DEFAULT 'nli',  -- nli, manual, inferred
...
CREATE TABLE IF NOT EXISTS conversation_analytics (
    ...
    conversation_id TEXT NOT NULL,
    user_id TEXT NOT NULL,
    metric_name TEXT NOT NULL,  -- response_time, task_success, user_satisfaction
...
CREATE INDEX IF NOT EXISTS idx_analytics_user_id ON conversation_analytics(user_id);
CREATE INDEX IF NOT EXISTS idx_analytics_metric ON conversation_analytics(metric_name);