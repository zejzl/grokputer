...
def execute_command(command: str) -> str:
    ...
    if any(char in command for char in dangerous_chars):
        return "Invalid command characters detected"

    # Whitelist of allowed commands
    allowed_commands = ["ls", "dir", "pwd", "echo", "cat", "head", "tail"]
...
class ToolExecutor:
    ...
    def __init__(self, require_confirmation: bool = None):
        ...
        self.require_confirmation = (
            require_confirmation if require_confirmation is not None else config.REQUIRE_CONFIRMATION
        )
    ...
    def execute_tool_calls(self, tool_calls: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for tool_call in tool_calls:
            try:
                ...
                results.append({"tool_call_id": tool_call_id, "function_name": function_name, "result": result})
    ...
    def _execute_bash(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                return {"status": "error", "error": f"Malformed command: {str(e)}", "safety_score": safety_score}
            ...
            return {"status": "error", "error": "Command timed out (30s limit)", "safety_score": safety_score}
            ...
            return {"status": "error", "error": str(e), "safety_score": safety_score}
    ...
    def _execute_computer(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if action == "mouse_move":
                ...
                return {"status": "success", "action": "mouse_move", "coordinate": [x, y]}
                ...
                return {"status": "success", "action": "screenshot", "message": "Screenshot is handled by observer"}

            else:
                return {"status": "error", "error": f"Unknown computer action: {action}"}
