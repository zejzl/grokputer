    ...
    async def process_message(self, message: Message) -> List[Message]:
        ...
        if message.message_type == 'proposed_action':
            ...
            if assessment['risk_level'] == 'low':
                ...
                self.session_logger.log_agent_activity(self.agent_id, f"Approved action: {action_data.get('command', 'N/A')}")
            else:
                # Reject
                ...
                self.session_logger.log_agent_activity(self.agent_id, f"Rejected action: {action_data.get('command', 'N/A')} - {assessment['reason']}")
