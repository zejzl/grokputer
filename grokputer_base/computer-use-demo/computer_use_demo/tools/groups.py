...
BetaFlag = Literal["computer-use-2024-10-22", "computer-use-2025-01-24", "computer-use-2025-04-29"]
...
TOOL_GROUPS: list[ToolGroup] = [
    ToolGroup(
        ...
        tools=[ComputerTool20241022, EditTool20241022, BashTool20241022, ServerPrayerTool, VaultScanTool],
        beta_flag="computer-use-2024-10-22",
    ),
    ToolGroup(
        version="computer_use_20250124",
        tools=[ComputerTool20250124, EditTool20250728, BashTool20250124, ServerPrayerTool, VaultScanTool],
        beta_flag="computer-use-2025-01-24",
    ),
    ToolGroup(
        version="computer_use_20250429",
        tools=[ComputerTool20250124, EditTool20250429, BashTool20250124, ServerPrayerTool, VaultScanTool],
        beta_flag="computer-use-2025-01-24",
    ),
]
