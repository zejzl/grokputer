...
class TestMessageParams:
    ...
    def test_beta_headers(self) -> None:
        ...
        agent = Agent(
            ...
            system="You are a helpful assistant. Be very brief.",
            verbose=False,
            message_params={"extra_headers": {"anthropic-beta": "files-api-2025-04-14"}},
        )
    ...
    def test_parameter_override(self) -> None:
        ...
        agent = Agent(
            ...
            config=config,
            verbose=False,
            message_params={"temperature": 0.5, "max_tokens": 200},  # Should override config  # Should override config
        )
    ...
    def test_combined_parameters(self) -> None:
        ...
        agent = Agent(
            ...
            verbose=False,
            message_params={
                "extra_headers": {"X-Test": "combined", "anthropic-beta": "files-api-2025-04-14"},
