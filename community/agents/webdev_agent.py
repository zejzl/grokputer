...
class WebDevAgent(BaseAgent):
    ...
    async def on_start(self) -> None:
        ...
        self.session_logger.log_agent_ready(self.agent_id, f"WebDevAgent ready (framework={self.framework})")
    ...
    async def _create_api(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.session_logger.log_agent_activity(self.agent_id, f"API creation: {result['message']}")
    ...
    async def _setup_auth(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.session_logger.log_agent_activity(self.agent_id, f"Auth setup: {auth_type}")
    ...
    async def _design_database(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.session_logger.log_agent_activity(self.agent_id, f"Database design: {len(entities)} entities")
    ...
    async def _write_tests(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        result = {
            ...
            "files_generated": ["test_api.py", "test_models.py", "test_auth.py", "conftest.py"],
        }

        self.session_logger.log_agent_activity(self.agent_id, f"Tests written: {test_type}")
    ...
    async def _generate_deployment(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.session_logger.log_agent_activity(self.agent_id, f"Deployment: {platform}")
    ...
    async def _review_code(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.session_logger.log_agent_activity(self.agent_id, f"Code review: {issues_found} issues")
    ...
    async def _debug_issue(self, content: Dict[str, Any]) -> Dict[str, Any]:
        ...
        self.session_logger.log_agent_activity(self.agent_id, f"Debug: {issue_type}")
...
"""
    ...
    async def on_stop(self) -> None:
        ...
        if self.task_history:
            self.session_logger.log_agent_message(self.agent_id, f"Completed {len(self.task_history)} tasks total")
