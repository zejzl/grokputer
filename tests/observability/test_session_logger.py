...
def test_session_logger_initialization():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logger = SessionLogger(session_id="test_session_001", task="Test task", log_dir=log_dir, swarm_mode=True)
...
def test_session_logger_agent_logging():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logger = SessionLogger(session_id="test_session_002", task="Test task", log_dir=log_dir, swarm_mode=True)
...
def test_session_logger_handoff():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logger = SessionLogger(session_id="test_session_003", task="Test task", log_dir=log_dir, swarm_mode=True)
...
def test_session_logger_messages():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logger = SessionLogger(session_id="test_session_004", task="Test task", log_dir=log_dir, swarm_mode=True)
...
def test_session_logger_tool_execution():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logger = SessionLogger(session_id="test_session_005", task="Test task", log_dir=log_dir, swarm_mode=False)

        logger.log_tool_execution(
            tool_name="bash", params={"command": "ls -la"}, result="file1.txt\nfile2.txt", status="success"
        )
...
def test_session_logger_confirmation():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logger = SessionLogger(session_id="test_session_006", task="Test task", log_dir=log_dir, swarm_mode=True)
...
def test_session_logger_finalize():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logger = SessionLogger(session_id="test_session_007", task="Test task", log_dir=log_dir, swarm_mode=True)
...
def test_session_logger_non_swarm_mode():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logger = SessionLogger(session_id="test_session_008", task="Test task", log_dir=log_dir, swarm_mode=False)
