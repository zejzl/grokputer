...
def session_logger(tmp_path):
    ...
    logger = SessionLogger(session_id="test_webdev_session", task="test_webdev_task", log_dir=tmp_path)
    return logger
...
class TestWebDevAgentAPICreation:
    ...
    async def test_create_api_with_grok_client(self, message_bus, session_logger):
        ...
        mock_grok = MagicMock()
        agent = WebDevAgent(
            agent_id="webdev_grok", message_bus=message_bus, session_logger=session_logger, grok_client=mock_grok
        )
        ...
        message = Message(
            ...
            message_type="create_api",
            content={"specification": {"endpoints": [{"path": "/api/data", "method": "GET"}]}},
            priority=MessagePriority.NORMAL,
        )
    ...
    async def test_design_database_schema(self, webdev_agent):
        ...
        message = Message(
            ...
            content={
                ...
                "relationships": [{"from": "Post", "to": "User", "type": "many-to-one"}],
            },
            priority=MessagePriority.NORMAL,
        )
...
class TestWebDevAgentTesting:
    ...
    async def test_write_unit_tests(self, webdev_agent):
        ...
        message = Message(
            ...
            content={"test_type": "unit", "coverage": 90},
            priority=MessagePriority.NORMAL,
        )
...
class TestWebDevAgentCodeReview:
    ...
    async def test_review_code_security(self, webdev_agent):
        ...
        message = Message(
            ...
            content={"code": "eval(user_input)", "focus": "security"},
...
class TestWebDevAgentDebugging:
    ...
    async def test_debug_performance_issue(self, webdev_agent):
        ...
        message = Message(
            ...
            content={"issue_type": "performance", "description": "API response time is slow"},
            priority=MessagePriority.HIGH,
        )
...
class TestWebDevAgentIntegration:
    ...
    async def test_full_api_development_workflow(self, webdev_agent):
        ...
        db_message = Message(
            ...
            to_agent="webdev",
            message_type="design_database",
            content={"entities": [{"name": "User", "fields": ["id", "email"]}], "relationships": []},
            priority=MessagePriority.NORMAL,
        )
        ...
        api_message = Message(
            ...
            to_agent="webdev",
            message_type="create_api",
            content={"specification": {"endpoints": [{"path": "/users", "method": "GET"}]}},
            priority=MessagePriority.NORMAL,
        )
